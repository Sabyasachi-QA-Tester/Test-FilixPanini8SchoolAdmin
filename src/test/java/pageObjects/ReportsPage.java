...
public class ReportsPage extends BasePage {
	...
	@FindBy(xpath="//a[@href='/school/report/list']")
	WebElement btn_Reports;
	
	@FindBy(xpath="//input[@placeholder='Search students by name or email...']")
	WebElement txt_SearchReports;
	
	@FindBy(xpath="//button[@class='absolute right-2 sm:right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600']")
	WebElement btn_cross;
	
	@FindBy(xpath="//tr[8]//td[4]//button[@tabindex='0' and normalize-space()='View Report']")
